...
$country[] = $row['country'];
$query = mysqli_query($koneksi,"select sum(activecases) as 'Active Cases' from tb_covid where id='".$row['id']."'");
$row = $query->fetch_array();
$datagrafik[] = $row['Active Cases'];
}
?>
<!doctype html>
<html>
    <head>
        ...
        <title>Active Cases Statistic</title>
    ...
    <body>
        ...
        <div class="container pt-3 pb-5">
            <div class="row text-center ">
                <div class="col ">
                    <h2 class="p-2">Active Cases Graphic</h2>
                </div>
            </div>
