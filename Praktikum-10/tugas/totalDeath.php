...
$country[] = $row['country'];
$query = mysqli_query($koneksi,"select sum(deaths) as 'Total Deaths' from tb_covid where id='".$row['id']."'");
$row = $query->fetch_array();
$datagrafik[] = $row['Total Deaths'];
}
?>
<!doctype html>
<html>
    <head>
        ...
        <title>Total Deaths Statistic</title>
    ...
    <body>
        ...
        <div class="container pt-3 pb-5">
            <div class="row text-center ">
                <div class="col ">
                    <h2 class="p-2">Total Deaths Graphic</h2>
                </div>
            </div>
