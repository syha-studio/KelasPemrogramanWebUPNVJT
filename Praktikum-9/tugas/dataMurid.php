  ...
  <body>
    ...
    <!-- Tabel dan Kontrol -->
      <div class="pt-2 pb-2 table-responsive">
        <table class="table table-striped table-bordered align-middle">
          <tr class="text-center">
            ...
            <th>Nama Ayah</th><th>Nama Ibu</th><th>Aksi</th>
          </tr>
          <?php $i = 1 ?>
      ...
      <div class="d-flex justify-content-end">
        <a href="reportdataMurid.php"><button type="button" class="btn btn-light"><i class="bi bi-file-earmark-arrow-down"></i> Download Data Murid</button></a>
      </div>
    </div>
  </body>
</html>